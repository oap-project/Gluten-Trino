...
import io.trino.plugin.tpch.protocol.GlutenTpchTableHandle;
        ...
        implements ConnectorTableHandle
{
    ...
    @Override
    public GlutenTpchTableHandle getProtocol()
    {
        return new GlutenTpchTableHandle(tableName, scaleFactor);
    }
}
