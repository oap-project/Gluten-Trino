...
import io.trino.spi.protocol.GlutenConnectorTableLayoutHandle;
        ...
        implements Module
{
    ...
    @ProvidesIntoSet
    public static com.fasterxml.jackson.databind.Module glutenColumnHandleModule(HandleResolver resolver)
    {
        return new AbstractTypedJacksonModule<>(GlutenColumnHandle.class, resolver::getGlutenId, resolver::getHandleClass) {};
    }

    @ProvidesIntoSet
    public static com.fasterxml.jackson.databind.Module glutenConnectorSplitModule(HandleResolver resolver)
    {
        return new AbstractTypedJacksonModule<>(GlutenConnectorSplit.class, resolver::getGlutenId, resolver::getHandleClass) {};
    }

    @ProvidesIntoSet
    public static com.fasterxml.jackson.databind.Module glutenConnectorTableHanldeModule(HandleResolver resolver)
    {
        return new AbstractTypedJacksonModule<>(GlutenConnectorTableHandle.class, resolver::getGlutenId, resolver::getHandleClass) {};
    }

    @ProvidesIntoSet
    public static com.fasterxml.jackson.databind.Module glutenConnectorTableLayoutHandleModule(HandleResolver resolver)
    {
        return new AbstractTypedJacksonModule<>(GlutenConnectorTableLayoutHandle.class, resolver::getGlutenId, resolver::getHandleClass) {};
    }

    @ProvidesIntoSet
    public static com.fasterxml.jackson.databind.Module glutenConnectorTransactionHandleModule(HandleResolver resolver)
    {
        return new AbstractTypedJacksonModule<>(GlutenConnectorTransactionHandle.class, resolver::getGlutenId, resolver::getHandleClass) {};
    }
