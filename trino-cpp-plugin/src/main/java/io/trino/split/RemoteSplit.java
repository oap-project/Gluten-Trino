...
import io.trino.velox.protocol.MockLocation;
import io.trino.velox.protocol.MockRemoteSplit;
        ...
        implements ConnectorSplit
{
    ...
    @Override
    public MockRemoteSplit getProtocol()
    {
        DirectExchangeInput directExchangeInput = (DirectExchangeInput) exchangeInput;
        MockRemoteSplit mockRemoteSplit = new MockRemoteSplit(new MockLocation(directExchangeInput.getLocation()), directExchangeInput.getTaskId());
        return mockRemoteSplit;
    }
