        ...
        implements MockConnectorSplit
{
    ...
    @JsonCreator
    public MockRemoteSplit(@JsonProperty("location") MockLocation location, @JsonProperty("remoteSourceTaskId") TaskId remoteSourceTaskId)
    {
