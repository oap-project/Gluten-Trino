...
public class MockVariableExpressionSerializer
        extends JsonSerializer<MockVariableReferenceExpression>
{
    private static final char VARIABLE_TYPE_OPEN_BRACKET = '<';
    private static final char VARIABLE_TYPE_CLOSE_BRACKET = '>';

    @Override
    public void serialize(MockVariableReferenceExpression value, JsonGenerator gen, SerializerProvider serializers)
            throws IOException
    {
