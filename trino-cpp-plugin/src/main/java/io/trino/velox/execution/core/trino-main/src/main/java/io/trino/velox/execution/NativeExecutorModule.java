...
import io.trino.velox.protocol.MockVariableExpressionSerializer;
import io.trino.velox.protocol.MockVariableReferenceExpression;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        if (serverConfig.getLaunchNativeEngine()) {
            ...
            jsonCodecBinder(binder).bindJsonCodec(MockPlanFragment.class);
        }
        else {
        ...
        JsonBinder.jsonBinder(binder).addKeySerializerBinding(MockVariableReferenceExpression.class).to(MockVariableExpressionSerializer.class);
