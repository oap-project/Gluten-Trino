        ...
        implements TaskExecution
{
    ...
    public NativeSqlTaskExecution(TaskContext taskContext, NativeSqlTaskExecutionManager taskExecutionManager, TaskStateMachine taskStateMachine, OutputBuffer outputBuffer, MockPlanFragment planFragment, Executor taskNotificationExecutor)
    {
    ...
    public int getOutputPartitionNum() {return outputPartitionNum;}
