...
public class MockBucketConversion
{
    ...
    @JsonProperty
    public List<MockHiveColumnHandle> getBucketColumnHandles()
    {
    ...
    public boolean equals(Object o)
    {
        ...
        MockBucketConversion that = (MockBucketConversion) o;
