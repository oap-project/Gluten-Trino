...
public class MockStorage
{
    ...
    private final Optional<MockHiveBucketProperty> bucketProperty;
    ...
    public MockStorage(
            ...
            @JsonProperty("bucketProperty") Optional<MockHiveBucketProperty> bucketProperty,
    ...
    @JsonProperty
    public Optional<MockHiveBucketProperty> getBucketProperty()
    {
    ...
    public boolean equals(Object o)
    {
        ...
        MockStorage storage = (MockStorage) o;
    ...
    public static MockStorage fromSchema(Properties schema)
    {
        ...
        //MockHiveBucketProperty mockHiveBucketProperty = MockHiveBucketProperty.fromSchema(schema);
        ...
        return new MockStorage(storageFormat, location, Optional.empty(), skewed, serdeParameters, parameters);
    }
}
