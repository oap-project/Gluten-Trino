...
import static io.trino.plugin.hive.protocol.MockBucketFunctionType.PRESTO_NATIVE;
import static java.util.Objects.requireNonNull;

public class MockHiveBucketProperty
{
    private final List<String> bucketedBy;
    private final int bucketCount;
    private final List<SortingColumn> sortedBy;
    private final MockBucketFunctionType bucketFunctionType;
    // TODO: Make sure we could use 'Type' directly, otherwise we need to write another mock interface.
    private final Optional<List<Type>> types;

    @JsonCreator
    public MockHiveBucketProperty(
            @JsonProperty("bucketedBy") List<String> bucketedBy,
            @JsonProperty("bucketCount") int bucketCount,
            @JsonProperty("sortedBy") List<SortingColumn> sortedBy,
            @JsonProperty("bucketFunctionType") MockBucketFunctionType bucketFunctionType,
    ...
    public static MockHiveBucketProperty fromSchema(Properties schema)
    {
        ...
        MockBucketFunctionType mockBucketFunctionType = MockBucketFunctionType.HIVE_COMPATIBLE;
        Optional<List<Type>> types = Optional.empty();

        return new MockHiveBucketProperty(bucketBy, bucketCount, sortedBy, mockBucketFunctionType, types);
    }
    ...
    @JsonProperty
    public MockBucketFunctionType getBucketFunctionType()
    {
    ...
    public boolean equals(Object o)
    {
        ...
        MockHiveBucketProperty that = (MockHiveBucketProperty) o;
