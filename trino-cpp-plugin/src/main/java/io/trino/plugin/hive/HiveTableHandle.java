...
import io.trino.plugin.hive.protocol.MockHiveTableHandle;
        ...
        implements ConnectorTableHandle
{
    ...
    @Override
    public MockHiveTableHandle getProtocol()
    {
        return new MockHiveTableHandle(schemaName, tableName, analyzePartitionValues);
    }
}
