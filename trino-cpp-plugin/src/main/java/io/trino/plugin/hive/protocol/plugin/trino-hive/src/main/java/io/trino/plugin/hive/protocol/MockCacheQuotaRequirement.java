...
public class MockCacheQuotaRequirement
{
    private final MockCacheQuotaScope cacheQuotaScope;
    private final Optional<DataSize> quota;

    @JsonCreator
    public MockCacheQuotaRequirement(
            @JsonProperty("cacheQuotaScope") MockCacheQuotaScope cacheQuotaScope,
    ...
    @JsonProperty
    public MockCacheQuotaScope getCacheQuotaScope()
    {
    ...
    public boolean equals(Object o)
    {
        ...
        MockCacheQuotaRequirement that = (MockCacheQuotaRequirement) o;
