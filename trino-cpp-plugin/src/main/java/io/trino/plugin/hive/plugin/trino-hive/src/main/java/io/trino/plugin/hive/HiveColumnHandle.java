        ...
        implements ColumnHandle
{
    ...
    @Override
    public MockHiveColumnHandle getProtocol()
    {
        MockHiveColumnHandle.ColumnType mockColumnType = switch (columnType) {
            case PARTITION_KEY -> MockHiveColumnHandle.ColumnType.PARTITION_KEY;
            case REGULAR -> MockHiveColumnHandle.ColumnType.REGULAR;
            case SYNTHESIZED -> MockHiveColumnHandle.ColumnType.SYNTHESIZED;
        };
        return new MockHiveColumnHandle(
                name,
                getHiveType(),
