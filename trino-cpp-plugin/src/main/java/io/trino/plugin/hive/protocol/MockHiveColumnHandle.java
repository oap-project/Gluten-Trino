...
import io.trino.spi.protocol.MockSubfield;
...
import static io.trino.plugin.hive.protocol.MockHiveColumnHandle.ColumnType.AGGREGATED;
import static io.trino.plugin.hive.protocol.MockHiveColumnHandle.ColumnType.PARTITION_KEY;
import static io.trino.plugin.hive.protocol.MockHiveColumnHandle.ColumnType.SYNTHESIZED;
import static java.lang.String.format;
import static java.util.Objects.requireNonNull;

public class MockHiveColumnHandle
        implements MockColumnHandle
{
    ...
    private final List<MockSubfield> requiredSubfields;

    @JsonCreator
    public MockHiveColumnHandle(
            ...
            @JsonProperty("requiredSubfields") List<MockSubfield> requiredSubfields)
    {
    ...
    @JsonProperty
    public List<MockSubfield> getRequiredSubfields()
    {
