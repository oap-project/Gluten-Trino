...
public class ServerConfig
{
    ...
    private boolean launchNativeEngine; // default: false
    ...
    @NotNull
    public boolean getLaunchNativeEngine()
    {
        return launchNativeEngine;
    }

    @Config("query.launch-native-engine")
    public ServerConfig setLaunchNativeEngine(boolean launchNativeEngine)
    {
        this.launchNativeEngine = launchNativeEngine;
        return this;
    }
}
