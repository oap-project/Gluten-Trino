...
import io.trino.velox.protocol.MockConnectorId;
import io.trino.velox.protocol.MockPartitioningHandle;
...
public class PartitioningHandle
{
    ...
    public MockPartitioningHandle getProtocol()
    {
        Optional<MockConnectorId> mockConnectorId = catalogHandle.map(handle -> new MockConnectorId(handle.getCatalogName()));
        Optional<MockConnectorTransactionHandle> mockConnectorTransactionHandle = transactionHandle.map(ConnectorTransactionHandle::getProtocol);
        return new MockPartitioningHandle(mockConnectorId, mockConnectorTransactionHandle, connectorHandle);
    }
}
