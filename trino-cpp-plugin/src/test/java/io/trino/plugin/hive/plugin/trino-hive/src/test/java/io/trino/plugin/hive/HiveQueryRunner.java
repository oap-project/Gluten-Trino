...
import io.trino.velox.protocol.MockCatalogProperties;
...
public final class HiveQueryRunner
{
            ...
            throws Exception
    {
        ...
        DistributedQueryRunner queryRunner = HiveQueryRunner.builder()
                ...
                .build();
        MockCatalogProperties mockCatalogProperties = new MockCatalogProperties("hive", "hive", new HashMap<>());
        registerConnector(jsonCodec(MockCatalogProperties.class).toJson(mockCatalogProperties));
        Thread.sleep(10);
