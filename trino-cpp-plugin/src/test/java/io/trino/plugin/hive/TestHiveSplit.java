...
public class TestHiveSplit
{
    ...
    @Test
    public void testMockHiveSplit()
    {
        ObjectMapperProvider objectMapperProvider = new ObjectMapperProvider();
        objectMapperProvider.setJsonDeserializers(ImmutableMap.of(Type.class, new TypeDeserializer(new TestingTypeManager())));
        JsonCodec<MockHiveSplit> codec = new JsonCodecFactory(objectMapperProvider).jsonCodec(MockHiveSplit.class);
        ...
        HiveSplit sourceHiveSplit = new HiveSplit(
                ...
                555534,
                SplitWeight.fromProportion(2.0)); // some non-standard value
        MockHiveSplit mockHiveSplit = sourceHiveSplit.getProtocol();
        String json = codec.toJson(mockHiveSplit);
