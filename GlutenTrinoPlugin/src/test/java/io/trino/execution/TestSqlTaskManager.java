...
public class TestSqlTaskManager
{
            ...
            throws InterruptedException, ExecutionException, TimeoutException
    {
        ...
        try {
            ...
            try (SqlTaskManager sqlTaskManager = createSqlTaskManager(taskManagerConfig, new NodeMemoryConfig(), taskExecutor, stackTraceElements -> true)) {
                ...
                glutenSplitRunner.waitForFinish();
    ...
    public static class GlutenDirectExchangeClientSupplier
    ...
    public static class GlutenLocationFactory
    ...
    private static class GlutenSplitRunner
