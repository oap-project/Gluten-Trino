...
import io.trino.velox.protocol.GlutenCatalogProperties;
...
import static io.trino.jni.TrinoBridge.registerConnector;
...
public final class HiveQueryRunner
{
    ...
    {
        Logging logging = Logging.initialize();
        logging.setLevel("io.trino.velox", Level.DEBUG);
        logging.setLevel("io.trino.jni.NativeLogger", Level.DEBUG);
        logging.setLevel("io.trino.velox.execution.HybridSqlTaskExecutionFactory", Level.DEBUG);
        logging.setLevel("io.trino.velox.execution.NativeSqlTaskExecutionManager", Level.DEBUG);
        ...
        DistributedQueryRunner queryRunner = HiveQueryRunner.builder()
                ...
                .setExtraProperties(ImmutableMap.<String, String>builder()
                        ...
                        .put("query.launch-native-engine", "true")
                ...
                .setMetastore(distributedQueryRunner -> new BridgingHiveMetastore(
                        testingThriftHiveMetastoreBuilder()
                                .metastoreClient(HostAndPort.fromParts("localhost", 9083), new Duration(30, SECONDS))
                                .build()))
                ...
                .build();
        GlutenCatalogProperties glutenCatalogProperties = new GlutenCatalogProperties("hive", "hive", new HashMap<>());
        registerConnector(jsonCodec(GlutenCatalogProperties.class).toJson(glutenCatalogProperties));
        Thread.sleep(10);
