...
public class DevelopmentLoaderConfig
{
    ...
    public String getTrinoCppConfig()
    {
        return trinoCppConfig;
    }
    ...
    @Config("trino-cpp.extrajars")
    public DevelopmentLoaderConfig setTrinoCppConfig(String config)
    {
        this.trinoCppConfig = config;
        return this;
    }
