        ...
        implements ColumnHandle
{
    ...
    @Override
    public GlutenHiveColumnHandle getProtocol()
    {
        GlutenHiveColumnHandle.ColumnType glutenColumnType = switch (columnType) {
            case PARTITION_KEY -> GlutenHiveColumnHandle.ColumnType.PARTITION_KEY;
            case REGULAR -> GlutenHiveColumnHandle.ColumnType.REGULAR;
            case SYNTHESIZED -> GlutenHiveColumnHandle.ColumnType.SYNTHESIZED;
        };
        return new GlutenHiveColumnHandle(
                name,
                getHiveType(),
