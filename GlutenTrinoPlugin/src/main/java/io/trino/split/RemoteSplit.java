...
import io.trino.velox.protocol.GlutenLocation;
import io.trino.velox.protocol.GlutenRemoteSplit;
        ...
        implements ConnectorSplit
{
    ...
    @Override
    public GlutenRemoteSplit getProtocol()
    {
        DirectExchangeInput directExchangeInput = (DirectExchangeInput) exchangeInput;
        GlutenRemoteSplit glutenRemoteSplit = new GlutenRemoteSplit(new GlutenLocation(directExchangeInput.getLocation()), directExchangeInput.getTaskId());
        return glutenRemoteSplit;
    }
