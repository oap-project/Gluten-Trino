...
import io.trino.plugin.hive.protocol.GlutenHiveTransactionHandle;
        ...
        implements ConnectorTransactionHandle
{
    ...
    @Override
    public GlutenHiveTransactionHandle getProtocol()
    {
        return new GlutenHiveTransactionHandle(uuid);
    }
}
