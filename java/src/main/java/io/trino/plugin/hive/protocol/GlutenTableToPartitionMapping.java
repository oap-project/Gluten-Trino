...
public class GlutenTableToPartitionMapping
{
    ...
    @JsonCreator
    public GlutenTableToPartitionMapping(
    ...
    {
        if (tableToPartitionColumns.map(GlutenTableToPartitionMapping::isIdentityMapping).orElse(true)) {
    ...
    public static GlutenTableToPartitionMapping create(TableToPartitionMapping mapping, List<Column> partitionColumns)
    {
        ...
        return new GlutenTableToPartitionMapping(tableToPartitionColumns, partitionSchemaDifference);
    }
