...
function install_protobuf {
  curl -L "https://github.com/protocolbuffers/protobuf/releases/download/v21.4/protobuf-cpp-3.21.4.tar.gz" -o protobuf-cpp-3.21.4.tar.gz
  tar -xzvf protobuf-cpp-3.21.4.tar.gz && cd protobuf-3.21.4
...
function install_conda {
  ...
  bash Miniconda3-latest-Linux-x86_64.sh -u -b -p $MINICONDA_PATH
}
